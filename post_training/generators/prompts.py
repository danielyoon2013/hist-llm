...
Return a JSON object:
{{"tasks": [{{"instruction": "Summarize the key developments described in this passage.", "response": "The passage describes..."}}]}}
...
Return a JSON object:
{{"examples": [{{"question": "What can you tell me about [post-period event]?", "response": "I don't have knowledge about events after {end_year}. However, based on what I know up to {end_year}, [relevant pre-period context].", "domain": "technology", "event_year": 2005}}]}}"""
